package id.fikri.testhttpurlconnection;
        ...
        try {
            ...
            for (int i = 0; i < users.length(); i++) {
                ...
                lbl_http_connection.append(
                        "Id = " + String.valueOf(user.getInt("id")) + System.getProperty("line.separator") +
                                "Email = " + user.getString("email") + System.getProperty("line.separator") +
                                "Password = " + user.getString("password") + System.getProperty("line.separator")
                );
            }
